...
function menuMapper1(item, tabindex) { return ["div", [item.title, ["div", item.options.map(menuMapper2), { class: "menu-expand" }]], { class: "menu-item", tabindex, [EVENT_LISTENERS]: [["mouseenter", focusMenu], ["click", clickOption]] }] }
